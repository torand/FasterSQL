 ...
 */
public class Ln implements SingleRowFunction {
    private final Expression expression;
    private final ColumnAlias alias;

    Ln(Expression expression, String alias) {
    ...
    public String sql(Context context) {
        return context.getDialect().formatLnFunction(expression.sql(context));
    }
    ...
    public Projection as(String alias) {
        ...
        return new Ln(expression, alias);
    }
    ...
    private ColumnAlias defaultAlias() {
        return ColumnAlias.generate("LN_");
    }
}
