...
public class Floor implements SingleRowFunction {
    private final Expression expression;
    private final String alias;

    Floor(Expression expression, String alias) {
    ...
    public String sql(Context context) {
        return "floor(%s)".formatted(expression.sql(context));
    }
    ...
    public Projection as(String alias) {
        ...
        return new Floor(expression, alias);
    }
    ...
    private String defaultAlias() {
        return "FLOOR_" + new Random().nextInt(999) + 1;
    }
}
