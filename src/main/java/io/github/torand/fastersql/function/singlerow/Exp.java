 ...
 */
public class Exp implements SingleRowFunction {
    private final Expression expression;
    private final ColumnAlias alias;

    Exp(Expression expression, String alias) {
    ...
    public String sql(Context context) {
        return "exp(%s)".formatted(expression.sql(context));
    }
    ...
    public Projection as(String alias) {
        ...
        return new Exp(expression, alias);
    }
    ...
    private ColumnAlias defaultAlias() {
        return ColumnAlias.generate("EXP_");
    }
}
