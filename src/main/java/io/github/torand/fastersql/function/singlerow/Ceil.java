...
public class Ceil implements SingleRowFunction {
    private final Expression expression;
    private final String alias;

    Ceil(Expression expression, String alias) {
    ...
    public String sql(Context context) {
        return context.getDialect().formatCeilFunction(expression.sql(context));
    }
    ...
    public Projection as(String alias) {
        ...
        return new Ceil(expression, alias);
    }
    ...
    private String defaultAlias() {
        return "CEIL_" + new Random().nextInt(999) + 1;
    }
}
