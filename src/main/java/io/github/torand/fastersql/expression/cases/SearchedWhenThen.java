...
/**
 * Implements the WHEN-THEN clause of a searched CASE expression.
 */
class SearchedWhenThen implements Sql {
    private final Predicate when;
    private final Expression then;

    SearchedWhenThen(Predicate when, Expression then) {
        this.when = requireNonNull(when, "No when predicate specified");
