...
public class InlineNumberConstant implements Constant {
    ...
    InlineNumberConstant(Number value, String alias) {
    ...
    public Projection as(String alias) {
        ...
        return new InlineNumberConstant(value, alias);
    }
    ...
    public Projection forColumn(Column column) {
        ...
        return new InlineNumberConstant(value, column.alias().map(Alias::name).orElse(null));
    }
}
