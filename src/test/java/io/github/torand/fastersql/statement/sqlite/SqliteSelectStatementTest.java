...
class SqliteSelectStatementTest extends SqliteTest {
    ...
    public void shouldHandleAggregates() {
        ...
        statementTester()
            ...
            .assertRowCount(1)
            .assertRow(1,
                "MIN_PRICE", isDouble(3778.45),
                "AVG_PRICE", isDoubleCloseTo(5444.68, 0.001),
    ...
    void shouldHandleSetOperations() {
        // Sqlite does not support ORDER BY in set operation operands and no parentheses around operands
